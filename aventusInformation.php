            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="about.html">Nog iets</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="information.php">Dit is Software development</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="aventusInformation.php">Dit is Aventus</a>
                        </li>
                        <li class="nav-item">
                                ...
                                <div class="blog-post">
                                    ...
                                    <div class="down-content">
                                        ...
                                        <p>You can browse different tags such as <a rel="nofollow"
                                                ...
                                                target="_parent">video</a>, etc. to see more CSS templates. Sed
                                            hendrerit rutrum arcu, non malesuada nisi. Sed id facilisis turpis. Donec
                                            justo elit, dapibus vel ultricies in, molestie sit amet risus. In nunc
                                            augue, rhoncus sed libero et, tincidunt tempor nisl. Donec egestas, quam eu
                                            rutrum ultrices, sapien ante posuere nisl, ac eleifend eros orci vel ante.
                                            ...
                                            non ipsum. Suspendisse id ipsum leo.
                                        </p>
